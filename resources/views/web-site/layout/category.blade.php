    ...
    <section id="category-grid">
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-3 no-margin sidebar narrow">
                            ...
                            <div id="collapseOne" class="accordion-body collapse">
                                <div class="accordion-inner">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="accordion-heading">
                                                <a href="#collapseSub2" data-toggle="collapse">laptop</a>
                                            </div>
                ...
                <div class="widget accordion-widget category-accordions">
                    <h1 class="border">Places </h1>
                    <div class="accordion">
                    <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle collapsed" data-toggle="collapse" href="#collapseOne2">
                                    Ampara
                                </a>
                            </div>
                            <div id="collapseOne2" class="accordion-body collapse">
                                <div class="accordion-inner">
                                    <ul>
                                        <li>
                                            <div class="accordion-heading">
                                                <a href="#" data-toggle="collapse">Kalmunai</a>
                                            </div>
                                            <div class="accordion-heading">
                                                <a href="#" data-toggle="collapse">Sainthamaruthu</a>
                                            </div>
                                            <div class="accordion-heading">
                                                <a href="#" data-toggle="collapse">Sainthamaruthu</a>
                                            </div> 
                            ...
                            <div class="accordion-heading">
                                <a class="accordion-toggle collapsed" data-toggle="collapse" href="#collapseOne3">
                                    Colombo
                                </a>
                            </div>
                            <div id="collapseOne3" class="accordion-body collapse">
                                <div class="accordion-inner">
                                    <ul>
                                        <li>
                                            <div class="accordion-heading">
                                                <a href="#" data-toggle="collapse">Maradana</a>
                                            </div>
                                            <div class="accordion-heading">
                                                <a href="#" data-toggle="collapse">test</a>
                                            </div>
                                            <div class="accordion-heading">
                                                <a href="#" data-toggle="collapse">test</a>
                                            </div> 
