                ...
                <div class="container">
                    ...
                    <div class="col-xs-12 col-sm-6 no-margin">
                        <ul class="right">
                            ...
                            <li><a href="{{route('authPage')}}">Register</a></li>
                            <li><a href="{{route('authPage')}}">Login</a></li>
                        </ul>
                    </div><!-- /.col -->
                </div><!-- /.container -->
            </nav>  
            <header>
                <div class="container no-padding">
                    <div class="col-xs-12 col-sm-12 col-md-3 logo-holder text-center">
                        ...
                        <div class="logo">
                            <a href="{{route('home')}}">
                                 <img alt="" width="190px" height="100px" src="{{asset('assets/images/logo.png')}}" />
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 top-search-holder no-margin">
                        <div class="contact-row">
                            <div class="phone inline">
                                <i class="fa fa-phone"></i>(+9467) 222 9998
                            </div>
                            <div class="contact inline">
                                <i class="fa fa-envelope"></i> info@<span class="le-color">kiblah.com</span>
                            </div>
                        </div><!-- /.contact-row -->
                        <!-- ============================================================= SEARCH AREA ============================================================= -->
